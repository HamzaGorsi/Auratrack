    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="relative border-b border-white/[0.04] overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#050505]/20 to-[#050505]" />
        </div>
        ...
        <div className="relative z-10 max-w-[1700px] mx-auto px-6 py-20">
          <div className="max-w-[900px]">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black mt-5 capitalize leading-none">
              {game}
            </h1>
